 ...
 *
 * Double opt-in is handled by Loops' built-in flow: when enabled in the
 * Loops dashboard, newly created contacts receive a confirmation email
 * automatically. No custom transactional email is needed.
 */
